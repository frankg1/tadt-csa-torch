...
关于alpha的消融。
'''
local_model_name = 'tadt-csa-sensitive4'
...
def train_model(args):
    ...
    log_dir =  f"./logs/sensitive/{local_model_name}_{args.delta}"
    ...
    for epoch in range(start_epoch, args.num_epochs + 1):
        ...
        for batch_idx, batch in enumerate(pbar):
            ...
            quantile_loss = quantile_ranking_loss(action_preds, rtg_seq, codebook_id, act_id_seq, loss_mask,args.beta, args.delta)
...
def main():
    ...
    parser.add_argument('--beta', type=float, default=0.8, help='Alpha for codebook')
    parser.add_argument('--delta', type=float, default=0.1, help='Alpha for codebook')
