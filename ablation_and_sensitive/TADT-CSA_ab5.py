...
class TADT_CSA(nn.Module):
    ...
    def forward(self, obs_seq, act_id_seq, rtg_seq, adv_seq, type_idx, time_idx, tgt_mask=None, key_padding_mask=None):
        ...
        return (action_preds, return_preds, cur_emb, next_emb, cur_act_emb, s_t_seq)
...
def train_model(args):
    ...
    for epoch in range(start_epoch, args.num_epochs + 1):
        ...
        for batch_idx, batch in enumerate(pbar):
            ...
            # 前向传播
            (action_preds, return_preds, cur_emb, next_emb, cur_act_emb, s_t_seq) = model(obs_seq, act_id_seq, rtg_seq, adv_seq, type_idx, time_idx,
            ...
            # quantile_loss = quantile_ranking_loss(action_preds, rtg_seq, act_id_seq, loss_mask)

            
            total_loss = action_loss + rtg_loss + adv_loss
